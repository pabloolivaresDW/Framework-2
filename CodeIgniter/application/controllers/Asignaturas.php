...
class Asignaturas extends CI_Controller {
	...
	public function agregar() {
		...
		$num_al=$this->input->post('num_al');

		$this->Asignaturas_model->set_asignatura($cod, $nom, $num_al);
    $this->output
      ->set_content_type('application/json')
      ->set_output(json_encode(array('mensaje' => 'La asignatura se ha agregado satisfactoriamente, Gracias!.')));
	}
	...
	public function editar() {
		...
		$this->Asignaturas_model->update_asignatura($cod, $nom, $num_al);
