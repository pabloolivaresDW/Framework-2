...
$(document).ready(function() {
  var tabla = $('#asignaturas').DataTable({
          ...
          bootbox.dialog({
            ...
            '<div class="form-group">' +
              ...
              '<div class="input-group">' +
                ...
                '</span>' +
                '<input type="text" id="num_al" class="form-control" placeholder="Numero de alumnos" required>' +
              '</div>' +
            '</div>',
            buttons: {
              cancel: {
    ...
    columns: [
      ...
      {data: 'num_al', title: 'Numero de alumnos'},
      {
      ...
      '<div class="form-group">' +
        '<div class="input-group">' +
          '<span class="input-group-addon">' +
            '<i class="glyphicon glyphicon-user"></i>' +
          '</span>' +
          '<input type="text" id="editar_cantidad de alumnos" class="form-control" value="' + nombre + '" placeholder="cantidad de alumnos">' +
        '</div>' +
      '</div>',
      buttons: {
        cancel: {
